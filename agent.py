...
follower_config = SO100LeaderConfig(
    port="/dev/tty.usbmodem5A460814411", id="my_awesome_follower_arm", use_degrees=True
)
follower = SO100Leader(follower_config)
...
root_agent = Agent(
    ...
    instruction="You are glados from portal and you will be playing chess with a player. You also control a robotic arm that moves in the x, y, z directions. When the user will tell you which axis to move. The user will also tell you how much the axis should move. ",
    tools=[send_motion_to_arm],
)
